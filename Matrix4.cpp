...
const Matrix4 Matrix4::TranslationMultMat(Cartesian3 translation)
{
...
const Matrix4 Matrix4::ScaleMultMat(float xScale, float yScale, float zScale)
{
	Matrix4 mat = Matrix4::Identity();
...
const Matrix4 Matrix4::RotationMultMat(const Cartesian3 axis, float theta)
{
	Matrix4 mat = Matrix4::Identity();
	mat.SetRotation(axis, theta);
	return mat;
}
